  ...
  <div class="flex min-h-screen">
    ...
    <aside class="fixed top-0 left-0 h-full w-64 bg-[#0d2236] p-6 flex flex-col items-center shadow-lg z-40">
      ...
      <a href="profiltoko-owner.php" class="flex items-center gap-3 hover:bg-white hover:text-[#123458] py-2 px-4 rounded-lg transition">
        ...
        <a href="aktivitastoko-owner.php" class="flex items-center gap-3 bg-white text-[#123458] py-2 px-4 rounded-lg font-semibold">
          🏪 Aktivitas Toko
        </a>
        <a href="daftarproduk-owner.php" class="flex items-center gap-3 hover:bg-white hover:text-[#123458] py-2 px-4 rounded-lg transition">
          📦 Data Produk
        </a>
      ...
      <div class="bg-white bg-opacity-10 backdrop-blur-md rounded-2xl p-6 shadow-xl">
        <div class="grid md:grid-cols-2 gap-6 items-center">
          ...
          <div>
            ...
            <button onclick="window.location.href='aktivitastoko-owner.php'" class="bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded-lg text-white"> Lihat Aktivitas</button>
            <button onclick="window.location.href='tampilanfeedbacktoko-owner.php'" class="bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded-lg text-white"> Lihat Penilaian</button>
            </div>
          </div>
        </div>
      </div>
