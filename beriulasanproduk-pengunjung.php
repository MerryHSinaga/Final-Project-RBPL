...
<head>
  ...
  <title>Beri Ulasan Produk - MJ Sport</title>
...
<body class="min-h-screen bg-gradient-to-b from-[#123458] to-black text-white font-sans">
  ...
  <div class="flex min-h-screen">
    ...
    <main class="ml-72 p-8 w-full">
      <div class="bg-white bg-opacity-10 backdrop-blur-md p-8 rounded-xl shadow-md max-w-3xl mx-auto">
        <h2 class="text-xl font-bold mb-6 text-center">Berikan Penilaian Terkait Produk kami!</h2>
        ...
        <form action="proses_ulasan.php" method="POST" enctype="multipart/form-data" class="space-y-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <select name="ukuran" required class="w-full p-2 rounded bg-white bg-opacity-20 backdrop-blur-md text-black focus:outline-none">
  ...
  <div id="success-modal" class="modal-container hidden">
    <div class="modal">
      ...
      <a href="lihatulasan-pengunjung.php?id=<?= $id_produk ?>" class="block bg-blue-500 hover:bg-blue-600 text-white py-2 rounded-full text-sm transition">Buka</a>
    </div>
  </div>
