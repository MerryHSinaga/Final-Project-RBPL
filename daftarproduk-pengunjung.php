      ...
      ?>
        <div class="bg-white bg-opacity-10 backdrop-blur-md rounded-2xl p-5 shadow-lg text-white">
          ...
          <div class="flex justify-between mt-4 flex-wrap gap-2">
            <a href="lihatproduk-pengunjung.php?id=<?= $id_produk ?>" class="bg-blue-500 hover:bg-yellow-600 px-4 py-2 rounded-lg text-white text-sm">Detail Produk</a>
            <a href="lihatulasan-pengunjung.php?id=<?= $id_produk ?>" class="bg-blue-500 hover:bg-yellow-600 px-4 py-2 rounded-lg text-white text-sm">Ulasan Produk</a>
          </div>
        </div>
      <?php
        }
