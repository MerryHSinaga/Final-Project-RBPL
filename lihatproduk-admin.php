      ...
      <div class="bg-white bg-opacity-10 backdrop-blur-md p-6 rounded-2xl shadow-lg space-y-6">
        ...
        <!-- Judul Produk -->
          <h2 class="text-3xl text-yellow-300 font-bold">Jersey Ultimate Pro - Edition 2025</h2>
            ...
            <button class="bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded-lg text-white">Rating : 4.8/5</button>
            <button onclick="window.location.href='updateproduk-admin.php'" class="bg-yellow-500 hover:bg-blue-600 px-4 py-2 rounded-lg text-black"> Edit Detail Produk </button> 
          </div>
        ...
        <button onclick="window.location.href='lihatulasan-admin.php'" class="bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded-lg text-white"> Lihat Ulasan</button> 
        </div>
      </div>
    </main>
  </div>
