...
<head>
  ...
  <title>Update Data Produk - MJ Sport</title>
  ...
  <div class="flex min-h-screen">
    ...
    <main class="ml-72 p-8 w-full">
      <div class="bg-white bg-opacity-10 backdrop-blur-md p-8 rounded-xl shadow-md max-w-3xl mx-auto">
        <h2 class="text-xl font-bold mb-6 text-center">Halo Admin! Silahkan Update data produk di bawah ini!</h2>

        <form action="lihatproduk-admin.php" method="POST" enctype="multipart/form-data" class="space-y-4">
        <div class="space-y-4">
  <div>
  <div>
      ...
      class="w-full p-2 rounded bg-white bg-opacity-20 backdrop-blur-md text-white placeholder-white focus:outline-none">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" name="warna" required class="w-full p-2 rounded bg-white bg-opacity-20 backdrop-blur-md text-white placeholder-white focus:outline-none">
            </div>
            <div>
            ...
            <div>
              ...
              <input type="number" name="jumlah" min="1" required class="w-full p-2 rounded bg-white bg-opacity-20 backdrop-blur-md text-white placeholder-white focus:outline-none">
            </div>
            <div>
              <label class="block text-sm">Unggah Gambar Thumbnail</label>
            ...
            <div>
        <label class="block text-sm">Unggah Gambar Lainnya</label>
        <input 
             type="file" name="gambar[]" accept="image/*" multiple class="w-full p-2 rounded bg-white bg-opacity-20 backdrop-blur-md text-white file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-white file:text-[#123458] hover:file:bg-gray-100">
        </div>
